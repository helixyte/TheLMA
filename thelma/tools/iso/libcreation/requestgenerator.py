...
from thelma.tools.handlers.poolcreationset import \
...
from thelma.tools.iso.libcreation.base import DEFAULT_ALIQUOT_PLATE_VOLUME
from thelma.tools.iso.libcreation.base import LibraryBaseLayout
...
class LibraryCreationIsoRequestGenerator(BaseTool):
    ...
    **Return Value:** :class:`thelma.entities.library.MoleculeDesignLibrary`
    ...
    def __init__(self, library_name, stream, requester, number_designs=1,
        ...
        #: The stock concentration for the single molecule design pools in nM.
        self.__stock_concentration = None
        #: The stock transfer volume for the single molecule design pools in
        #: ul.
