...
.. currentmodule:: thelma.tools.parsers.base
...
Excel files (see :mod:`thelma.tools.metadata.generation`).
...
* The excel sheet containing the ISO layout to be parsed must be
  ...
  (see :mod:`thelma.tools.parsers.experimentdesign`).
...
from thelma.tools.parsers.base \
        import ExcelMoleculeDesignPoolLayoutParsingContainer
from thelma.tools.parsers.base import ExcelMoleculeDesignPoolLayoutParser
