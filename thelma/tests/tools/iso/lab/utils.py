...
class LAB_ISO_TEST_CASES(object):
    ...
    def get_stock_takeout_volumes(cls, case_name):
        ...
        if case_name == cls.CASE_ORDER_ONLY:
            ...
            return {205201 : 1, 330001 : 1, 1056000 : 1}
        elif case_name == cls.CASE_LIBRARY_2_ALIQUOTS:
    ...
    def get_stock_rack_layout_data(cls, case_name):
        ...
        if case_name == cls.CASE_ORDER_ONLY:
            s1 = dict(
                b1=[205201, '1000205201', [TransferTarget('b2', 2, 'a')]],
                b2=[330001, '1000330001', [TransferTarget('b4', 2, 'a')]],
                b3=[333803, '1000333803', [TransferTarget('b6', 2, 'a')]],
                b4=[1056000, '1001056000', [TransferTarget('b8', 2, 'a')]],
                b5=[180005, '1000180005', [TransferTarget('b10', 2, 'a')]])
            ...
            s11 = dict(
                ...
                c4=[180005, '1000180005', [TransferTarget('c8', 5.5, 'p')]],
                b6=[205205, '1000205205', [TransferTarget('c12', 5.5, 'p')]],
                c6=[205206, '1000205206', [TransferTarget('e12', 5.5, 'p')]])
            s12 = dict(
                b2=[205201, '1000205201', [TransferTarget('c3', 5.5, 'p')]],
                c2=[205202, '1000205202', [TransferTarget('e3', 5.5, 'p')]],
                b4=[205203, '1000205203', [TransferTarget('c7', 5.5, 'p')]],
                c4=[180005, '1000180005', [TransferTarget('c8', 5.5, 'p')]],
                b6=[205207, '1000205207', [TransferTarget('c12', 5.5, 'p')]],
                c6=[205208, '1000205208', [TransferTarget('e12', 5.5, 'p')]])
            ...
            s1 = dict(
                ...
                e2=[330001, '1000330001', [TransferTarget('e2', 1, 'jp')]],
                e3=[180005, '1000180005', [TransferTarget('e3', 1, 'jp')]])
            s21 = dict(
                c1=[205203, '1000205203', [TransferTarget('c3', 1, 'p')]])
            s22 = dict(
                c1=[205209, '1000205203', [TransferTarget('c3', 1, 'p')]])
            s31 = dict(
                c1=[205202, '1000205202', [TransferTarget('c2', 1, 'p')]],
                c2=[205204, '1000205204', [TransferTarget('c4', 1, 'p')]])
            s32 = dict(
                c1=[205208, '1000205208', [TransferTarget('c2', 1, 'p')]],
                c2=[205210, '1000205210', [TransferTarget('c4', 1, 'p')]])
            s41 = dict(
                d1=[205206, '1000205206', [TransferTarget('d3', 1, 'p')]])
            s42 = dict(
                d1=[205214, '1000205206', [TransferTarget('d3', 1, 'p')]])
            s51 = dict(
                d1=[205205, '1000205205', [TransferTarget('d2', 1, 'p')]],
                d2=[205207, '1000205207', [TransferTarget('d4', 1, 'p')]])
            s52 = dict(
                d1=[205212, '1000205205', [TransferTarget('d2', 1, 'p')]],
                d2=[205215, '1000205215', [TransferTarget('d4', 1, 'p')]])
            return {'123_job_01_s#1' : s1,
                    '123_iso_01_s#2' : s21, '123_iso_02_s#2' : s22,
                    '123_iso_01_s#3' : s31, '123_iso_02_s#3' : s32,
            ...
            s1 = dict(
                a1=[205201, '1000205201', [TransferTarget('f1', 1, 'jp')]],
                b1=[330001, '1000330001', [TransferTarget('f2', 1, 'jp')]],
                c1=[180005, '1000180005', [TransferTarget('f3', 1, 'jp')]])
            s21 = dict(
                b2=[205202, '1000205202', [TransferTarget('b2', 1, 'jp')]],
                b3=[205203, '1000205203', [TransferTarget('b3', 1, 'jp')]],
                b4=[205204, '1000205204', [TransferTarget('b4', 1, 'jp')]],
                d2=[205205, '1000205205', [TransferTarget('d2', 1, 'jp')]],
                d3=[205206, '1000205206', [TransferTarget('d3', 1, 'jp')]],
                d4=[205207, '1000205207', [TransferTarget('d4', 1, 'jp')]])
            s22 = dict(
                b2=[205208, '1000205208', [TransferTarget('b2', 1, 'jp')]],
                b3=[205209, '1000205209', [TransferTarget('b3', 1, 'jp')]],
                b4=[205210, '1000205210', [TransferTarget('b4', 1, 'jp')]],
                d2=[205212, '1000205212', [TransferTarget('d2', 1, 'jp')]],
                d3=[205214, '1000205214', [TransferTarget('d3', 1, 'jp')]],
                d4=[205215, '1000205215', [TransferTarget('d4', 1, 'jp')]])
            return {'123_job_01_s#1' : s1,
                    '123_iso_01_s#2' : s21, '123_iso_02_s#2' : s22}
        elif case_name == cls.CASE_LIBRARY_SIMPLE:
            s1 = dict(
                b1=[205201, '1000205201', [TransferTarget('b1', 1, 'jp')]],
                d1=[330001, '1000330001', [TransferTarget('d1', 1, 'jp')]],
                f1=[1056000, '1001056000', [TransferTarget('f1', 1, 'jp')]])
            return {'123_job_01_s#1' : s1}
        elif case_name == cls.CASE_LIBRARY_2_ALIQUOTS:
            s1 = dict(
    ...
    def get_stock_rack_worklist_series_for_job(cls, case_name):
        ...
        # all stock rack worklists have BiomekStock as pipetting specs
        # and SAMPLE_TRANSFER as transfer type
        if case_name == cls.CASE_ASSOCIATION_DIRECT:
            return {'123_1_s#1_to_a' : 0}
        elif case_name == cls.CASE_ASSOCIATION_SIMPLE:
            return {'123_1_s#1_to_p' : 0}
        elif case_name == cls.CASE_ASSOCIATION_NO_CYBIO:
            return {'123_1_s#1_to_jp' : 0}
        elif case_name == cls.CASE_ASSOCIATION_2_ALIQUOTS:
            return {'123_1_s#1_to_p' : 0}
        elif case_name == cls.CASE_ASSOCIATION_JOB_LAST:
            return {'123_5_s#1_to_jp' : 0}
        elif case_name == cls.CASE_ASSOCIATION_SEVERAL_CONC:
            return {'123_2_s#1_to_jp' : 0}
        elif case_name == cls.CASE_LIBRARY_SIMPLE:
            return {'123_1_s#1_to_jp' : 0}
        elif case_name == cls.CASE_LIBRARY_2_ALIQUOTS:
            return {'123_1_s#1_to_jp' : 0}
    ...
    def get_stock_rack_worklist_series_for_iso(cls, case_name):
        ...
        if case_name == cls.CASE_ORDER_ONLY:
            ...
            return {'123_2_s#2_to_a' : 0,
                    '123_3_s#3_to_a' : 0}
        elif case_name == cls.CASE_ASSOCIATION_96:
            return {'123_2_s#1_to_p' : 0}
        elif case_name == cls.CASE_ASSOCIATION_SIMPLE:
            return {'123_2_s#2_to_p' : 0,
                    '123_3_s#3_to_p' : 0}
        elif case_name == cls.CASE_ASSOCIATION_NO_CYBIO:
            return {'123_2_s#2_to_p' : 0}
        elif case_name == cls.CASE_ASSOCIATION_2_ALIQUOTS:
    ...
    def get_stock_rack_worklist_details(cls, case_name, worklist_label):
        ...
        if case_name == cls.CASE_ORDER_ONLY:
            if worklist_label == '123_1_s#1_to_a':
                return dict(b2=[2, 'b1'], b4=[2, 'b2'], b6=[2, 'b3'],
                            b8=[2, 'b4'], b10=[2, 'b5'])
        elif case_name == cls.CASE_NO_JOB_DIRECT:
            if worklist_label == '123_1_s#1_to_a':
                return dict(b2=[2, 'b1'], d2=[2, 'b1'],
                    b4=[2, 'b2'], d4=[2, 'b2'], b6=[2, 'b3'], d6=[2, 'b3'],
                    b8=[2, 'b4'], d8=[2, 'b4'], b10=[2, 'b5'], d10=[2, 'b5'])
        elif case_name == cls.CASE_NO_JOB_1_PREP:
            ...
            if worklist_label == '123_1_s#1_to_p':
                ...
                return  dict(b2=[34, 'a1'], c2=[3, 'b1'], d2=[2, 'c1'],
                             e2=[3, 'd1'], f2=[3, 'e1'])
        elif case_name == cls.CASE_ASSOCIATION_DIRECT:
            if worklist_label == '123_1_s#1_to_a':
                return dict(b2=[2, 'a1'], d2=[2, 'a1'],
                    b3=[2, 'b1'], d3=[2, 'b1'], b4=[2, 'c1'], d4=[2, 'c1'])
            elif worklist_label == '123_2_s#2_to_a':
                return dict(c3=[2, 'b2'])
            elif worklist_label == '123_3_s#3_to_a':
                return dict(c2=[2, 'b1'], c4=[2, 'b2'])
        elif case_name == cls.CASE_ASSOCIATION_96:
            if worklist_label == '123_2_s#1_to_p':
                return dict(c3=[5.5, 'b2'], e3=[5.5, 'c2'], c7=[5.5, 'b4'],
                    c8=[5.5, 'c4'], c12=[5.5, 'b6'], e12=[5.5, 'c6'])
        elif case_name == cls.CASE_ASSOCIATION_SIMPLE:
            if worklist_label == '123_1_s#1_to_p':
                return dict(b2=[1, 'a1'], d2=[1, 'a1'],
                    b3=[1, 'b1'], d3=[1, 'b1'], b4=[1, 'c1'], d4=[1, 'c1'])
            elif worklist_label == '123_2_s#2_to_p':
                return dict(c3=[1, 'b2'])
            elif worklist_label == '123_3_s#3_to_p':
            ...
            if worklist_label == '123_1_s#2_to_p':
                return dict(c3=[1, 'c1'])
            elif worklist_label == '123_2_s#3_to_p':
                return dict(c2=[1, 'c1'], c4=[1, 'c2'])
            elif worklist_label == '123_3_s#4_to_p':
                return dict(d3=[1, 'd1'])
            elif worklist_label == '123_4_s#5_to_p':
                return dict(d2=[1, 'd1'], d4=[1, 'd2'])
            elif worklist_label == '123_5_s#1_to_jp':
                return dict(e1=[1, 'e1'], e2=[1, 'e2'], e3=[1, 'e3'])
        elif case_name == cls.CASE_ASSOCIATION_SEVERAL_CONC:
            if worklist_label == '123_1_s#2_to_p':
                return dict(b2=[1, 'b2'], b3=[1, 'b3'], b4=[1, 'b4'],
                            d2=[1, 'd2'], d3=[1, 'd3'], d4=[1, 'd4'])
            elif worklist_label == '123_2_s#1_to_jp':
                return dict(f1=[1, 'a1'], f2=[1, 'b1'], f3=[1, 'c1'])
        elif case_name == cls.CASE_LIBRARY_SIMPLE:
            if worklist_label == '123_1_s#1_to_jp':
                return dict(b1=[1, 'b1'], d1=[1, 'd1'], f1=[1, 'f1'])
        elif case_name == cls.CASE_LIBRARY_2_ALIQUOTS:
            if worklist_label == '123_1_s#1_to_jp':
...
class TestRackGenerator(object):
...
class LabIsoTestCase2(LabIsoTestCase1):
    ...
    def set_up(self):
        ...
        self.rack_generator = TestRackGenerator()
    ...
    def __generate_pool_set(self, iso_label):
        ...
        pools = set_data[iso_label]
        mt = self._get_pool(pools[0]).molecule_type
    ...
    def _compare_stock_rack_layout(self, layout_data, rack_layout,
                                   entity_label):
        converter = StockRackLayoutConverter(rack_layout=rack_layout,
                                             log=SilentLog())
        layout = converter.get_result()
        if layout is None:
            raise AssertionError('Unable to convert stock rack layout for ' \
                                 'entity "%s".' % (entity_label))
        self.assert_equal(layout.shape.name, RACK_SHAPE_NAMES.SHAPE_96)
        layout_name = 'stock rack layout for entity "%s"' % (entity_label)
        tested_labels = []
        # pos_label - pool, tube barcode, transfer_targets
        for rack_pos, plate_pos in layout.iterpositions():
            pos_label = rack_pos.label.lower()
