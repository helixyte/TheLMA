...
class IsoRequestTicketCreator(BaseTracTool):
    ...
    **Return Value:** ticket ID
    ...
    def __init__(self, requester, experiment_metadata_label,
                 logging_level=logging.WARNING, add_default_handlers=False):
        """
        Constructor:

        :param experiment_metadata_label: The label of the experiment metadata.
        :type experiment_metadata_label: :class:`string`
