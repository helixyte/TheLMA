...
class StockSampleCreationIsoRequestGenerator(BaseTool):
    ...
    **Return Value:** :class:`thelma.models.iso.StockSampleCreationIsoRequest`
    ...
    def __init__(self, iso_request_label, stream, target_volume,
        ...
        :param int target_volume: The final volume for the new pool stock tubes
            in ul (positive number).
        :param int target_concentration: The final pool concentration for the new
            pool stock tubes in nM (positive number).
        """
...
class StockSampleCreationIsoCreator(BaseTool):
    """
                ...
                msg = 'You must specify either 1 ticket number (in which ' \
                      ...
                      '%i numbers: %s.' \
                       % (remaining_isos, len(self.ticket_numbers),
                          self._get_joined_str(self.ticket_numbers,
                                               is_strs=False))
                self.add_error(msg)
