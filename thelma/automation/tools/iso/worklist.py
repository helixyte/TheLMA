...
class IsoWorklistSeriesGenerator(BaseAutomationTool):
    ...
    **Return Value:**  worklist series
    ...
    def run(self):
        ...
        if not self.has_errors():
            if experiment_type_id == EXPERIMENT_SCENARIOS.MANUAL:
                self.__create_worklist_for_manual_scenario()
            else:
                self.__create_worklist_for_non_manual_scenario()
    ...
    def __create_worklist_for_manual_scenario(self):
        """
        Create the worklist series for a manual scenario.
        """
    ...
    def __create_worklist_for_non_manual_scenario(self):
        """
        Create the worklist series for other scenarios.
        """
