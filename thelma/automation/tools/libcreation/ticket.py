...
#
#        :param layout_number: References the library layout the ISO is created
#            for.
...
#                                requester=self.__iso_request.requester,
#                                iso_label=iso_label,
...
#
#        writer = LibraryCreationStockLogFileWriter(log=self.log,
#                    library_layout=self._working_layout,
#                    executed_worklists=self._executed_worklists,
#                    sample_stock_racks=sample_stock_racks)
#        return writer
#
#
#
