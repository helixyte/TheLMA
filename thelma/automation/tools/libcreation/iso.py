...
class LibraryCreationIsoPopulator(BaseAutomationTool):
    """
    ...
    **Return Value:** The newly populated ISOs.
    ...
    def __populate_isos(self):
        ...
        plate_specs_96 = get_plate_specs_from_reservoir_specs(ir_specs_96)
        ir_specs_384 = get_reservoir_specs_standard_384()
        plate_specs_384 = get_plate_specs_from_reservoir_specs(ir_specs_384)
...
class LibraryCreationIsoLayoutWriter(CsvWriter):
    ...
    **Return Value:** stream (CSV format)
    ...
    def __init__(self, library_creation_iso,
        ...
        :param library_creation_iso: The ISO whose library layout you want
            to print.
    ...
    def _init_column_map_list(self):
        if self._check_input_class('ISO', self.library_creation_iso,
                                    LibraryCreationIso):
            self.__store_values()
