...
from thelma.automation.tools.libcreation.writer import LibraryCreationWorklistWriter
...
class LibraryCreationExecutor(BaseTool):
    ...
    **Return Value:** the updated ISO
    ...
    def __create_aliquot_transfer_jobs(self):
        ...
        aliquot_plates = dict()
        for iap in self.stock_sample_creation_iso.iso_aliquot_plates:
            plate = iap.plate
...
class LibraryCreationBufferWorklistTransferJobCreator(BaseTool):
    ...
    **Return Value:** transfer jobs mapped onto job indices.
    ...
    def __init__(self, stock_sample_creation_iso, pool_stock_racks,
    ...
    def __check_input(self):
        ...
        self._check_input_class('library creation ISO',
                                self.stock_sample_creation_iso, LibraryCreationIso)
